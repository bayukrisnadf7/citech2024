...
@section('content')
    <div class="flex p-5 gap-10">
        <div class="bg-gradient-to-r from-primary to-teal-800 w-1/3 rounded-3xl">
            <div class="p-5">
                <div class="flex text-3xl gap-2 text-white ">
                    <p>Hemat Energi </p>
                    <p class="font-bold">dan Uang </p>
                </div>
                <p class="text-3xl text-white font-bold">Anda Sekarang.</p>
                <p class="max-w-64 mt-5 text-white">Gunakan energi terbarukan dengan langkah mudah, bergabunglah dengan paket
                    Pro
                    kami untuk merasakan layanan
                    penuh
                    kami.</p>
                <p class="max-w-64 mt-5 text-white">Mulailah 14 hari uji coba Pro gratis, Anda dapat terus meningkatkan atau
                    tetap menggunakan versi Lite secara
                    gratis.</p>
                <button class="bg-white p-2 mt-5 rounded-lg">Coba Gratis</button>
            </div>
            <div class="flex justify-center">
                <img src="img/orang.png" alt="orang" width="300">
            </div>
        </div>
        <div>
            ...
            <div class="flex gap-10">
                <div class="bg-slate-200 p-5 rounded-3xl mt-10">
                    ...
                    <div class="mt-10">
                        ...
                        <div class="flex justify-center mt-28">
                            <button class="p-3 bg-primary mt-5 rounded-lg text-white font-bold w-80">Beli Paket
                                Silver</button>
                        </div>
                    </div>
                </div>
                <div class="bg-secondary p-5 rounded-3xl mt-10 text-white">
