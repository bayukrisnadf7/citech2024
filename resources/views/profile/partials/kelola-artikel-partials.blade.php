<div class="--container flex flex-col gap-6">
    <div class="--filter flex flex-col gap-4">
        <div class="--filtering w-full grid grid-cols-[2fr_1fr] gap-4">
            ...
            <div class="relative">
                <button class="--card p-4 w-full shadow-11 h-full bg-[#171717] hover:bg-[#D1F16A] hover:text-black text-white cursor-pointer rounded-[10px] text-center text-[14px] font-normal">Buat Artikel</button>
            </div>
        </div>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium underline text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <a href="#" class="font-medium text-red-600 dark:text-red-500 hover:underline ml-6">Hapus</a>
                    </td>
                </tr>
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    <th scope="row" class="px-6 underline py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 underline font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        Google Pixel Phone
                    </th>
                    <td class="px-6 py-4">
                        Gray
